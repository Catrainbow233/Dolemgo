...
import net.catrainbow.dolemgo.command.data.CommandData;
import net.catrainbow.dolemgo.command.data.CommandEnumData;
import net.catrainbow.dolemgo.command.data.CommandParam;
import net.catrainbow.dolemgo.command.data.CommandParamData;
...
public abstract class Command {
    ...
    public CommandData craftNetwork() {
        ...
        return new CommandData(this.name, this.getDescription(), Collections.emptyList(), (byte) 0, new CommandEnumData(this.name, aliases.toArray(new String[]{}), false), parameterData);
    }
}
